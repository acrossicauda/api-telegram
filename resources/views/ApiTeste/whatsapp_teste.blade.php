...
<body>
    <div class="content">
        <div class="row title">
            <h3>Teste API Whatsapp</h3>
        </div>
        <div class="row body">
            <form action="" method="post" id="form" onsubmit="event.preventDefault(); sendForm(this)">
                {{ csrf_field() }}}
                <div class="row">
                ...
                <div class="row">
                    <span></span><button class="btn btn-default" name="send" id="send">Enviar</button>
                </div>
            </form>
        </div>
    </div>
